...
{
    static auto* ctor = jl_eval_string("@__MODULE__().Mousetrap.Vector2f");
...
{
    static auto* ctor = jl_eval_string("@__MODULE__().Mousetrap.Vector2i");
...
{
    static auto* ctor = jl_eval_string("@__MODULE__().Mousetrap.Vector3f");
...
{
    static auto* ctor = jl_eval_string("@__MODULE__().Mousetrap.Vector4f");
...
{
    static auto* ctor = jl_eval_string("return @__MODULE__().Mousetrap.RGBA");
...
{
    static auto* ctor = jl_eval_string("return @__MODULE__().Mousetrap.HSVA");
